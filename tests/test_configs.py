...
config_values = {
    ...
    "doom_config_path": (
        "test/path/config.cfg" if os.name != "nt" else "test\\path\\config.cfg"
    ),
    "doom_game_path": (
        "test/path/doom.wad" if os.name != "nt" else "test\\path\\doom.wad"
    ),
    "doom_map": "map02",
    "doom_scenario_path": (
        "test/path/scenario.cfg" if os.name != "nt" else "test\\path\\scenario.cfg"
    ),
    "doom_skill": 4,
