...
if __name__ == "__main__":
    ...
    # Set number of tic frames stored in the observation buffer. (default 4, has to be lesser than 4)
    game.set_sound_observation_num_frames(4)
    ...
    for i in range(episodes):
        ...
        while not game.is_episode_finished():
            ...
            print("State #" + str(n))
            print("Average Audio:", np.mean(audio_buffer))
