...
- [gymnasium_vect_bench.py](https://github.com/mwydmuch/ViZDoom/blob/master/examples/python/gymnasium_vect_bench.py)
Benchmarks Gymnasium vectorized ViZDoom environments for different vectorization modes and number of environments.

- [learning_stable_baselines3.py](https://github.com/mwydmuch/ViZDoom/blob/master/examples/python/learning_stable_baselines3.py)
...
- [buildin_reward_functions.py](https://github.com/mwydmuch/ViZDoom/blob/master/examples/python/buildin_reward_functions.py)
...
- [cig_singleplayer.py](https://github.com/mwydmuch/ViZDoom/blob/master/examples/python/cig_singleplayer.py), [cig_singleplayer_host.py](https://github.com/mwydmuch/ViZDoom/blob/master/examples/python/cig_singleplayer_host.py)
...
- [notifications_buffer.py](https://github.com/mwydmuch/ViZDoom/blob/master/examples/python/notifications_buffer.py)
Demonstrates how to enable and read notifications buffer values from game state.

- [objects_and_sectors.py](https://github.com/mwydmuch/ViZDoom/blob/master/examples/python/objects_and_sectors.py)
...
- [test_pytorch.py](https://github.com/mwydmuch/ViZDoom/blob/master/examples/python/test_pytorch.py)
