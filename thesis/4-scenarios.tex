...
\section{Creating scenarios}\label{sec:creating_scenarios}
	...
	\subsection{Advices}
		...
		\paragraph{Ending} 
		\paragraph{Reward for Killing a Monster}
		\paragraph{Friendly Monster}
		\paragraph{Stationary Monster}
		\paragraph{Single Hit Monster}
		\paragraph{Infinite Ammo}
		\paragraph{Disappearing Corpses}