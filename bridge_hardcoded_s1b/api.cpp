...
static PyObject *api_close(PyObject *self, PyObject *args);
...
static PyMethodDef module_methods[] = {
	...
	{"close", api_close, METH_VARARGS, NULL},
...
static PyObject * api_init(PyObject *self, PyObject *args)
{
    ...
    /* Parse arguments */
    if (!PyArg_ParseTuple(args, "iii", &_x, &_y, &_maxtime))
    {
        return NULL;
    }   
...
static PyObject *api_make_action(PyObject *self, PyObject *args)
{
	printf("Tu dziala 1 /n");
    if (is_finished())
    {
        printf("Gra sie skonczyla, przykro mi.\n");
		close();
        return NULL;
    }
	printf("Tu dziala 2 /n");
