...
#define ENUM_VAL_2_PYT(v) .value( #v , v )
    ...
    class_<DoomGamePython>("DoomGame", init<>())
		...
		.def("set_doom_path", &DoomGamePython::setDoomPath)
		.def("set_game_file_path", &DoomGamePython::setGameFilePath)
		.def("set_scenario_file_path", &DoomGamePython::setScenarioFilePath)
